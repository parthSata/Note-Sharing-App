...
// .wrangler/tmp/bundle-VxHwx5/strip-cf-connecting-ip-header.js
...
function assertShareLinkIsValid(shareLink) {
  ...
  if (new Date(shareLink.expiresAt) < /* @__PURE__ */ new Date()) {
    throw new ShareServiceError(
      410,
...
// .wrangler/tmp/bundle-VxHwx5/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-VxHwx5/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
app.use(
  ...
  cors({
    origin: (origin, c) => {
      ...
      return normalizedOrigin && allowedOrigins.has(normalizedOrigin) ? origin : null;
    },
