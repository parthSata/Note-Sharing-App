...
// .wrangler/tmp/bundle-1QVpSM/strip-cf-connecting-ip-header.js
...
function jsonError(c, code, message, status = 400) {
...
authRoutes.post(
  "/register",
  (c) => jsonError(c, "NOT_IMPLEMENTED", "Auth routes are scaffolded only.", 501)
);
authRoutes.post(
  "/login",
  (c) => jsonError(c, "NOT_IMPLEMENTED", "Auth routes are scaffolded only.", 501)
...
function createApp() {
  ...
  app2.route("/auth", authRoutes);
  app2.route("/notes", notesRoutes);
  app2.route("/share", shareRoutes);
  app2.notFound((c) => {
    return c.json(
      {
        error: {
...
// .wrangler/tmp/bundle-1QVpSM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-1QVpSM/middleware-loader.entry.ts
